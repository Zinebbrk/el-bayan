...
export function SignUp({ onSignIn, onSignUp }: SignUpProps) {
    ...
    <div className="min-h-screen bg-[#FEF9ED] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-[#5A4A2F] mb-2">Join El-Bayan</h1>
          <p className="text-muted-foreground">Create your account and start learning Arabic</p>
        </div>
        ...
        <Card className="p-8 border-[#D4A574] border-2 shadow-md bg-white rounded-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-[#5A4A2F]">Full Name</Label>
              <Input
                id="fullName"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#5A4A2F]">Confirm Password</Label>
              <div className="relative">
                <Input
                  id="confirmPassword"
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="size-4 mt-0.5 rounded border-[#D4A574] text-[#6B8F3D] focus:ring-[#6B8F3D]"
                required
              />
              <label htmlFor="terms" className="text-muted-foreground cursor-pointer">
                I agree to the{" "}
                <button type="button" className="text-[#6B8F3D] hover:underline">
                  Terms of Service
                </button>{" "}
                and{" "}
                <button type="button" className="text-[#6B8F3D] hover:underline">
